...
def mostrar_menu():
    ...
    while True:
        ...
        eleccion_Semanas = input("Elige una Semana o '0' para salir: ")
        if eleccion_Semanas == '0':
            print("Saliendo del programa.")
            break
        elif eleccion_Semanas in Semanas:
            mostrar_sub_menu(os.path.join(ruta_base, Semanas[eleccion_Semanas]))
        else:
